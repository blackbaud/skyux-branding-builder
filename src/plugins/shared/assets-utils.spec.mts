...
describe('assets-utils', () => {
  const projectName = 'skyux-brand-test';
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe('fixAssetsUrl', () => {
    it('should return original value when basePath is undefined', () => {
      ...
      const result = fixAssetsUrl(undefined, value, projectName);
    ...
    it('should replace ~/assets/ with basePath when basePath is provided', () => {
      ...
      const result = fixAssetsUrl(basePath, value, projectName);
      expect(result).toBe(expected);
    });
    ...
    it('should return CDN url when package environment variable set', () => {
      ...
      const expected =
        'https://sky.blackbaudcdn.net/static/skyux-brand-test/0.0.1/assets/fonts/roboto-regular.ttf';
      const result = fixAssetsUrl(basePath, value, projectName);
  ...
  describe('fixAssetsUrlValue', () => {
    it('should return original value when basePath is undefined', () => {
      ...
      const result = fixAssetsUrlValue(undefined, value, projectName);
      expect(result).toBe(expected);
    });
    ...
    it('should replace ~/assets/ with basePath when basePath is provided', () => {
      ...
      const result = fixAssetsUrlValue(basePath, value, projectName);
      expect(result).toBe(expected);
    });
    ...
    it('should return CDN url when package environment variable set', () => {
      ...
      const value = '~/assets/fonts/roboto-regular.ttf';
      const expected =
        "url('https://sky.blackbaudcdn.net/static/skyux-brand-test/0.0.1/assets/fonts/roboto-regular.ttf')";
      const result = fixAssetsUrlValue(basePath, value, projectName);
  ...
  describe('generateAssetsCss', () => {
    ...
    it('should generate CSS font declarations with assets base path', async () => {
      ...
      const result = await generateAssetsCss(basePath, projectName);
...
@font-face {
  ...
  font-display: swap;
    ...
    it('should generate CSS font declarations with the CDN url when package environment variable set', async () => {
      ...
      const expected = `@font-face {
  font-family: 'Roboto';
  src: url('https://sky.blackbaudcdn.net/static/skyux-brand-test/0.0.1/assets/fonts/roboto-variable.ttf');
  font-weight: 100 900;
  font-style: normal;
  font-display: swap;
}
...
@font-face {
  font-family: 'Roboto';
  src: url('https://sky.blackbaudcdn.net/static/skyux-brand-test/0.0.1/assets/fonts/roboto-italic-variable.ttf');
  font-weight: 100 900;
  font-style: italic;
  font-display: swap;
}`;
    ...
    it('should return empty string when assets.json does not exist', async () => {
      ...
      const result = await generateAssetsCss('/assets/', projectName);
    ...
    it('should handle JSON parsing errors', async () => {
      ...
      await expect(
        generateAssetsCss('/assets/', projectName),
      ).rejects.toThrow();
    ...
    it('should handle file reading errors', async () => {
      ...
      await expect(generateAssetsCss('/assets/', projectName)).rejects.toThrow(
        'File read error',
      );
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'Error generating font CSS:',
