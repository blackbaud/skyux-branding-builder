...
export type { PublicStyleSet as PublicClassSet } from './src/types/public-class-set.ts';
...
export type { PublicApiStyles } from './src/types/public-api-styles.js';
export type { PublicApiStyleGroup } from './src/types/public-api-style-group.js';
export type { PublicApiStyle } from './src/types/public-api-style.js';
